...
class ListMirror1Test(BaseTest):
    ...
    """
    fixtureCmds = [
        "aptly mirror create --ignore-signatures mirror1 http://cdn-fastly.deb.debian.org/debian/ bullseye",
        "aptly mirror create -with-sources --ignore-signatures mirror2 http://cdn-fastly.deb.debian.org/debian/ bullseye contrib",
        "aptly -architectures=i386 mirror create --ignore-signatures mirror3 http://cdn-fastly.deb.debian.org/debian/ bullseye non-free",
