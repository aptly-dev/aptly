...
class PublishRepo29Test(BaseTest):
    """
    publish repo: -use-symlinks
    """
    fixtureCmds = [
        "aptly repo create local-repo",
        "aptly repo add local-repo ${files}",
    ]
    runCmd = "aptly publish repo -use-symlinks -keyring=${files}/aptly.pub -secret-keyring=${files}/aptly.sec -distribution=maverick local-repo"
    gold_processor = BaseTest.expand_environ

    def check(self):
        super(PublishRepo29Test, self).check()
        ...
        self.check_file_is_symlink('public/pool/main/p/pyspi/pyspi_0.6.1-1.3.dsc')
        self.check_file_is_symlink('public/pool/main/p/pyspi/pyspi_0.6.1-1.3.diff.gz')
        self.check_file_is_symlink('public/pool/main/p/pyspi/pyspi_0.6.1.orig.tar.gz')
        self.check_file_is_symlink('public/pool/main/p/pyspi/pyspi-0.6.1-1.3.stripped.dsc')
