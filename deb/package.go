...
func (p *Package) LinkFromPool(publishedStorage aptly.PublishedStorage, packagePool aptly.PackagePool,
	prefix, component string, force bool, symlinks bool) error {
	...
	for i, f := range p.Files() {
		...
		err = publishedStorage.LinkFromPool(publishedDirectory, packagePool, sourcePath, f.Checksums.MD5, force, symlinks)
		if err != nil {
			return err
		}
